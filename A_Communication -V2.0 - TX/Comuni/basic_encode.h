...
extern uint8_t Dynamic_key; /* 外部调用动态密码数 */
extern uint64_t Time4_stamp;       /* 用于1毫秒定时器计数 */
...
extern uint16_t MSG116_1;   
extern uint16_t MSG116_2;  
extern uint16_t MSG116_3; 
extern uint16_t MSG101_1;   

#define Threshold 1000

#define IF_DEBUG 0  /* 1-使能串口4打印数据，0-不使能串口4打印数据*/
#define MW_Header 0X5A

#define UART3_TX_BUF_SIZE 200  /* 定义串口3发送数组大小*/
#define UART3_RX_BUF_SIZE 200  /* 定义串口3发送数组大小*/
#define UART2_RX_BUF_SIZE 200  /* 定义串口2接收数组大小*/


#define MSG_ID_FX 1  /*飞行数据包ID*/
#define MSG_ID_YK 2  /*遥控器数据包ID*/
#define MSG_ID_ZT 3  /*状态数据*/
#define MSG_ID_HX 4  /*航线数据*/
#define MSG_ID_HD 5  /*航点数据*/
#define MSG_ID_DC 6  /*参数读取*/



#define MSG_LEN_FX 56  /*飞行数据包大小*/
#define MSG_LEN_YK 15  /*遥控器数据包ID*/
#define MSG_LEN_ZT 24  /*状态数据*/
#define MSG_LEN_HX 19  /*航线数据*/
#define MSG_LEN_HD 22  /*航点数据*/
#define MSG_LEN_DC 55  /*参数读取*/
